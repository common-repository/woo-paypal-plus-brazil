...
if ( ! class_exists( 'WC_PayPay_Plus_Brazil' ) ) {
	...
	class WC_PayPay_Plus_Brazil {
		...
		public function create_menus() {
			add_submenu_page(
				'tools.php',
				__( 'PayPal Plus Migration Tool', 'woo-paypal-plus-brazil' ),
				__( 'PayPal Plus Migration Tool', 'woo-paypal-plus-brazil' ),
				'administrator',
				'paypal-plus-brazil-migration-tool',
				array( $this, 'migration_tool_page' )
			);
		}

		public function migration_tool_page() {
			include dirname( __FILE__ ) . '/includes/admin/views/html-page-migration-tool.php';
		}
		...
		private function includes() {
			...
			include_once dirname( __FILE__ ) . '/includes/class-wc-paypal-plus-brazil-ipn.php';
		}
		...
		public function update_notice() {
			include dirname( __FILE__ ) . '/includes/admin/views/html-notice-update.php';
		}
	 ...
	 * Init function.
	 */
	function woo_paypal_plus_brazil_init() {
		// Init plugin.
		add_action( 'plugins_loaded', array( 'WC_PayPay_Plus_Brazil', 'get_instance' ) );

		// Activation and deactivation hooks.
		register_activation_hook( __FILE__, array( 'WC_PayPay_Plus_Brazil', 'install' ) );
		register_deactivation_hook( __FILE__, array( 'WC_PayPay_Plus_Brazil', 'uninstall' ) );
	}

	// Init plugin.
	woo_paypal_plus_brazil_init();
